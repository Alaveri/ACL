...
namespace ACL.Data.Sql
{
    ...
    public class SqlDatabaseAccessor : DatabaseAccessor
    {
        ...
        public override IDbTransaction BeginTransaction(IsolationLevel isolationLevel = IsolationLevel.Unspecified, string name = null)
        {
            return ((SqlConnection)Connection).BeginTransaction(isolationLevel, name);
        }
        ...
        public SqlDatabaseAccessor(string connectionString = null, SqlCredential credential = null) : base(connectionString)
        {
            connectionString = connectionString ?? throw ExceptionFactory.CreateArgumentNullException(connectionString);
