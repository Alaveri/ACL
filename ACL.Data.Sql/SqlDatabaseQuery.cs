...
namespace ACL.Data.Sql
{
    ...
    public class SqlDatabaseQuery : DatabaseQuery
    {
        ...
        [SuppressMessage("Security", "CA2100:Review SQL queries for security vulnerabilities", Justification = "This is up to the code using the DatabaseAccessor.")]
        protected virtual SqlCommand PrepareCommand(IDatabaseQueryOptions options)
        {
            options = options ?? throw ExceptionFactory.CreateArgumentNullException(options);
