...
namespace ACL.Core.Extensions.Conversion
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Converts a variable from one type to another and returns a default if the conversion is invalid.
        /// </summary>
        ...
        public static TResult ChangeType<TResult>(this object value) where TResult : IConvertible
        {
            return SafeConvert.ChangeType<TResult>(value, default);
        }
